defmodule Rotor do
  ...
  defdelegate define(name, paths, rotor_fn, options), to: Rotor.GroupServer, as: :add
  defdelegate define(name, paths, rotor_fn),          to: Rotor.GroupServer, as: :add
  ...
  # Retaining for backwards compatability
